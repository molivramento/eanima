...
class Category(ormar.Model):
    ...
    starting: datetime = ormar.Date(default=datetime.today)
    ending: datetime = ormar.Date(nullable=True, default=None)
    discount: float = ormar.Decimal(decimal_places=5, max_digits=6, default=1.00)
    starting_discount: datetime = ormar.Date(nullable=True, default=None)
    ending_discount: datetime = ormar.Date(nullable=True, default=None)
